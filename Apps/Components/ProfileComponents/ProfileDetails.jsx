...
export default function ProfileDetails({ userData, numberOfPosts }) {
        ...
        <View style={{ paddingHorizontal: 15 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                <Avatar.Image
                    ...
                    size={80}
                    style={{ height: 80, width: 80, borderRadius: 4, backgroundColor: "white" }}
                />
                <View style={{ width: 75, alignItems: "center" }}>
                    <Text style={{ fontSize: 24, fontWeight: "bold", color: "black" }}>{numberOfPosts}</Text>
                    <Text style={{ fontSize: 16, color: "black" }}>Posts</Text>
                </View>
                <View style={{ width: 75, alignItems: "center" }}>
                    <Text style={{ fontSize: 15, fontWeight: "bold", color: "black", }}>{userData.role === "1" ? "Car Owner" : "Client"}</Text>
                    <Text style={{ fontSize: 16, color: "black" }}>Role</Text>
                </View>
            </View>
            <Text style={{ fontSize: 18, color: "black", fontWeight: "500", marginTop: 16 }}>{userData.name}</Text>
            <Text style={{ color: "black", marginTop: 4 }}>{userData.email}</Text>
            <Text style={{ color: "black", marginTop: 4 }}>{userData.phoneNumber}</Text>
            ...
            <View style={{ flexDirection: "row", marginTop: 15, justifyContent: "space-between", marginHorizontal: 10 , marginBottom:5}}>
