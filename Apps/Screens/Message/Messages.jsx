...
import { getFirestore, doc, collection, addDoc, serverTimestamp, onSnapshot } from 'firebase/firestore';
...
export default function Message({ route, navigation }) {
  ...
  const ChatHeader = () => (
    <View style={{ padding: 10, alignItems:'center' }}>
      <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Chatting with {ownerData.name}</Text>
    </View>
  );
