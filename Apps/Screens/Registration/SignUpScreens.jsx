  ...
  const handelSignUp = async (values) => {
    ...
    try {
      ...
      await setDoc(userRef, {
        ...
        role: values.role,
        id: user.uid,
        profileImage:"https://firebasestorage.googleapis.com/v0/b/test-b60fa.appspot.com/o/profile_Images%2FDPI.jpg?alt=media&token=2fbf1079-965f-441b-bff7-ec95a6105b5e",
        favorites:[]
      });
